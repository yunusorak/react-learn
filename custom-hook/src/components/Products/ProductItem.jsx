...
const ProductItem = ({ product }) => {
  const { image, description, name, id, price, amount, rating } = product;
    ...
    <>
      <Card className={"product-card"}>
        <div className="mx-auto w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <a href="/">
            <img
              className="p-8 mx-auto min-h-[300px] max-h-[30px] max-w-[270px] rounded-t-lg"
              width="250px"
              src={image}
              alt={description}
            />
          ...
          <div className="px-5 pb-5">
            <a href="/">
              ...
              <h6 className="my-3 max-h-[95px] overflow-hidden">
                {description}
              </h6>
            </a>
